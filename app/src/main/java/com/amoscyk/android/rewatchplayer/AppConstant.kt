...
object AppConstant {
    ...
    const val PROD_FIREBASE_CLOUD_FUNCTIONS_URL = "https://asia-east2-pacific-formula-257111.cloudfunctions.net/"
    const val DEV_FIREBASE_CLOUD_FUNCTIONS_URL = "http://10.0.2.2:5001/pacific-formula-257111/asia-east2/"
