...
class PlayerViewModel(
    ...
    private val _adaptiveUrls = MutableLiveData<AdativeStreamUrl>()
    val adaptiveUrls: LiveData<AdativeStreamUrl> = _adaptiveUrls
        ...
        viewModelScope.launch {
            ...
            if (availableStream != null) {
                if (availableStream.videoStreamFormat.containsKey(itag)) {
                    ...
                    if (v != null && a != null) {
                        _adaptiveUrls.value = AdativeStreamUrl(v, a!!)
                    } else {
